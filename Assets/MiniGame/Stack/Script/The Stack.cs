...
namespace MiniGame.Stack
{
    public class TheStack : MonoBehaviour
    {
        ...
        private Vector3 prevBlockPostion;
        ...
        bool Spawn_Block()
        {
            ...
            newTrans.localPosition = prevBlockPostion + Vector3.up;
        ...
        bool PlaceBlock()
        {
            ...
            if (isMovingX)
            {
                float deltaX = prevBlockPostion.x - lastPosition.x;
                ...
                if (deltaX > ErrorMargin)
                {
                    ...
                    float middle = (prevBlockPostion.x + lastPosition.x) / 2f;
                ...
                {
                    ComboCheck();
                    lastBlock.localPosition = prevBlockPostion + Vector3.up;
                }
            }
            else
            {
                float deltaZ = prevBlockPostion.z - lastPosition.z;
                ...
                if (deltaZ > ErrorMargin)
                {
                    ...
                    float middle = (prevBlockPostion.z + lastPosition.z) / 2f;
                    lastBlock.localScale = new Vector3(stackBounds.x, 1, stackBounds.y);
